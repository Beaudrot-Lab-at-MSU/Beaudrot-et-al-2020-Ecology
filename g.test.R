# Function for G test  from https://stat.ethz.ch/pipermail/r-help/2001-September/015290.html. 
# See also spreadsheet for calculating G test of independence at http://udel.edu/~mcdonald/statgtestind.html. 


# The null hypothesis in a G-test of independece is that the relative proportions of one variable are independent of the second variable, 
# i.e. that the proportions at one variable are the same for different variables. 
# For example, with 3 flower phenotypes (red, pink, white) at 4 geographic locations, 
# the null hypothesis is that the proportions of red, pink and white flowers are the same at four locations. 
# A significant result (p < alpha) indicates that the null hypothesis can be rejected and 
# that the 3 phenotypes have significantly different proportions at the four locations.

# Citation for method: It may be cited as pp. 64-69 in: 
# McDonald, J.H. 2009. Handbook of Biological Statistics (2nd ed.). 
